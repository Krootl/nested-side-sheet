...
SideSheetTransitionBuilder leftSideSheetTransition = (child, animation) =>
    SlideTransition(
      position: animation
...
SideSheetTransitionBuilder rightSideSheetTransition = (child, animation) =>
    SlideTransition(
      position: animation
          .drive(CurveTween(curve: Curves.easeOutCubic))
          .drive(Tween<Offset>(begin: const Offset(1, 0), end: Offset.zero)),
...
SideSheetTransitionBuilder bottomSideSheetTransition =
    (child, animation) => SlideTransition(
          position: animation
              .drive(CurveTween(curve: Curves.easeOutCubic))
              .drive(Tween(begin: const Offset(0, 1), end: Offset.zero)),
